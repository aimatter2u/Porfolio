...
![분할 결과](/img/split_conclusion.png)
- 분할된 데이터의 클래스별 이미지 수가 다 적절하게 나누어진 것을 확인

#### 이미지 생성기 구축
![이미지 생성기](/img/generator_code.png)
...
![clssification_report](/img/report.png)
...
![matrix](/img/mobilenet_matrix.png)
